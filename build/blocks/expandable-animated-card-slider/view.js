...
/***/ "./src/blocks/expandable-animated-card-slider/Components/Common/Style.js":
/*!*******************************************************************************!*\
  !*** ./src/blocks/expandable-animated-card-slider/Components/Common/Style.js ***!
  \*******************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("style", {
    dangerouslySetInnerHTML: {
      __html: `
		 ...
		 ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)("", styles?.card?.headingText?.typo)?.googleFontLink}
		 ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)("", styles?.card?.title?.typo)?.googleFontLink}
		 ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)("", styles?.card?.description?.typo)?.googleFontLink}

		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(`${eaclTitleSl}`, styles?.card?.headingText?.typo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(`${eaclCardTitleSl}`, styles?.card?.title?.typo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(`${eaclCardDesSl}`, styles?.card?.description?.typo)?.styles}
		...
		${eaclCardSl}{
			margin:${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(styles?.card?.margin)};
			...
			${eaclTitleSl}{
				...
				padding: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(styles?.card?.headingText?.padding)};
				margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(styles?.card?.headingText?.margin)};
			}
			${eaclTitleSl}::after{
			...
			${eaclCardTitleSl}{
				...
				margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(styles?.card?.title?.margin)};
			}
			${eaclCardDesSl}{
				color: ${styles?.card?.description?.color};
				margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(styles?.card?.description?.margin)};
			}


			${eaclCardSl}::after{
				${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBackgroundCSS)(styles?.card?.overlay)}
			}
		${eaclCardSl}.active{
			width: ${styles?.card?.width.active?.desktop};
			height: ${styles?.card?.height.active?.desktop};
			box-shadow:${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getMultiShadowCSS)(styles?.card?.activeShadow)};
		}

		${eaclDotsContainerSl}{
      margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(styles?.dots?.margin)};
      gap: ${styles?.dots?.gap}px;
		...
		${eaclNavSl} button.owl-next {
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBackgroundCSS)(styles?.nav?.bg)}
			color: ${styles?.nav?.color} !important;
			width: ${styles?.nav?.size}px !important;
			height: ${styles?.nav?.size}px !important;
			border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(styles?.nav?.radius)} !important;
		}
...
/***/ "./src/blocks/expandable-animated-card-slider/Components/Common/sCards/OneCard.js":
/*!****************************************************************************************!*\
  !*** ./src/blocks/expandable-animated-card-slider/Components/Common/sCards/OneCard.js ***!
  \****************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const CarouselInner = ({
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    const initCarousel = () => {
      ...
      $carousel.owlCarousel({
        ...
        navText: [sliderSettings?.slideIcon?.left || "prev", sliderSettings?.slideIcon?.right || "next"],
      ...
      $carousel.off("click", ".eacl-card").on("click", ".eacl-card", function () {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ref: carouselRef,
    className: "owl-carousel eacl-carousel owl-theme"
  }, cards.map((card, index) => {
    const isActive = initialOpenCardNumber >= 1 && index === initialOpenCardNumber - 1;
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      key: index,
      ...
      className: "eacl-card-description"
    }, sliderSettings?.titleShow && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h3", {
      className: "eacl-card-title"
    }, card.title), sliderSettings?.descriptionShow && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
      className: "eacl-card-des"
    }, card.description)));
  }));
};
...
const OneCard = ({
  ...
  const {
    initialOpenCardNumber = -1
  } = sliderSettings;
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("section", {
    className: "eacl-container"
  }, sliderSettings?.headingShow && !RichTextComponent && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h2", {
    className: "eacl-title"
  }, sliderSettings?.headingText), sliderSettings?.headingShow && RichTextComponent && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(RichTextComponent, {
    ...
    tagName: "h2",
    className: "eacl-title"
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(CarouselInner, {
...
/***/ "./src/blocks/expandable-animated-card-slider/style.scss":
/*!***************************************************************!*\
  !*** ./src/blocks/expandable-animated-card-slider/style.scss ***!
  \***************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
(() => {
/*!************************************************************!*\
  !*** ./src/blocks/expandable-animated-card-slider/view.js ***!
  \************************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_dom_client__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-dom/client */ "./node_modules/react-dom/client.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/expandable-animated-card-slider/style.scss");
/* harmony import */ var _Components_Common_Style__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Components/Common/Style */ "./src/blocks/expandable-animated-card-slider/Components/Common/Style.js");
/* harmony import */ var _Components_Common_sCards_OneCard__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Components/Common/sCards/OneCard */ "./src/blocks/expandable-animated-card-slider/Components/Common/sCards/OneCard.js");
...
document.addEventListener('DOMContentLoaded', () => {
  const blockNameEls = document.querySelectorAll('.wp-block-icb-expandable-animated-card-slider-pro');
  blockNameEls.forEach(blockNameEl => {
    ...
    (0,react_dom_client__WEBPACK_IMPORTED_MODULE_1__.createRoot)(blockNameEl).render((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_Common_Style__WEBPACK_IMPORTED_MODULE_3__["default"], {
      attributes: attributes,
      id: blockNameEl.id
    }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_Common_sCards_OneCard__WEBPACK_IMPORTED_MODULE_4__["default"], {
      attributes
    })));
