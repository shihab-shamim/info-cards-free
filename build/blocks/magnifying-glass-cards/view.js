...
/***/ "./src/blocks/magnifying-glass-cards/Components/Common/Style.js":
/*!**********************************************************************!*\
  !*** ./src/blocks/magnifying-glass-cards/Components/Common/Style.js ***!
  \**********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    dangerouslySetInnerHTML: {
      __html: `
		 ...
		 ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)("", styles?.card?.title?.typo)?.googleFontLink}
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(titleSL, styles?.card?.title?.typo)?.styles}
		
		${cardsContainerSl} {
			grid-template-columns: repeat(${styles?.columns?.desktop}, 1fr);
			row-gap: ${styles?.rowGap}px;
			column-gap: ${styles?.columnGap}px;
			border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(styles?.border)};
		...
		outline:${styles?.card?.outline?.width} ${styles?.card?.outline?.style} ${styles?.card?.outline?.color};
		...
		border:${styles?.card?.glass?.border?.width} ${styles?.card?.glass?.border?.style} ${styles?.card?.glass?.border?.color};
		box-shadow:${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getMultiShadowCSS)(styles?.card?.glass?.shadow)};
...
/***/ "./src/blocks/magnifying-glass-cards/Components/Common/mCard/OneCard.js":
/*!******************************************************************************!*\
  !*** ./src/blocks/magnifying-glass-cards/Components/Common/mCard/OneCard.js ***!
  \******************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const OneCard = ({
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    if (!$ || !gsap || !Splitting) {
      console.error("Required libraries (jQuery, GSAP, or Splitting) are not loaded.");
      return;
    }
    if (ScrollTrigger) {
    ...
    let ctx = gsap.context(() => {
      ...
      Splitting({
        target: $splitTexts.toArray(),
        whitespace: true
      });

      // 3. GSAP Animations with scoped selections
      $cardGrid.find(".mgcb-card").each(function () {
        var _styles$card$image$br, _styles$card$image$cl, _styles$card$image$cl2, _styles$card$image$cl3, _styles$card$image$sc, _styles$card$image$du, _styles$card$image$de;
        const $this = $(this);
        gsap.set($this.find(".mgcb-split-text .char, img.mgcb-card-image, .mgcb-try-it"), {
          clearProps: "all"
        });
        const tlParams = {};
        ...
        tl.from($this.find(".mgcb-split-text .char"), {
          ...
          stagger: 0.05,
          ease: "power2.out"
        }).to($this.find("img.mgcb-card-image"), {
          filter: `brightness(${(_styles$card$image$br = styles?.card?.image?.brightness) !== null && _styles$card$image$br !== void 0 ? _styles$card$image$br : 1})`,
          clipPath: `circle(${(_styles$card$image$cl = styles?.card?.image?.clip?.radius) !== null && _styles$card$image$cl !== void 0 ? _styles$card$image$cl : 400}px at ${(_styles$card$image$cl2 = styles?.card?.image?.clip?.focus) !== null && _styles$card$image$cl2 !== void 0 ? _styles$card$image$cl2 : 82}% ${(_styles$card$image$cl3 = styles?.card?.image?.clip?.spotlight) !== null && _styles$card$image$cl3 !== void 0 ? _styles$card$image$cl3 : 82}%)`,
          scale: (_styles$card$image$sc = styles?.card?.image?.scale) !== null && _styles$card$image$sc !== void 0 ? _styles$card$image$sc : 1,
          duration: (_styles$card$image$du = styles?.card?.image?.duration) !== null && _styles$card$image$du !== void 0 ? _styles$card$image$du : 3,
          ease: "expo.inOut"
        }, (_styles$card$image$de = styles?.card?.image?.delay) !== null && _styles$card$image$de !== void 0 ? _styles$card$image$de : 0.8).to($this.find(".mgcb-try-it"), {
          scale: 1,
          duration: 0.5,
          ease: "back.out(4)"
        }, 1.5).to($this.find(".mgcb-try-it"), {
          rotate: 15,
    ...
    return () => {
      ...
      if (window.jQuery && containerRef.current) {
        window.jQuery(containerRef.current).find(".mgcb-card").off("mousemove mouseleave");
      }
    };
  }, [cards, options?.isMagnifyingIconShow, styles]); // Keeping dependencies to minimum

  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "mgcb-card-grid",
    ref: containerRef
    ...
    className: "mgcb-text"
  }, options?.isTitleShow && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h1", {
    className: "mgcb-split-text",
    "data-splitting": ""
  }, card.title)), options?.isMagnifyingIconShow && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "mgcb-try-it"
    ...
    className: "mgcb-magnifying-glass"
  }))));
};

// 5. Wrap with React.memo to prevent unnecessary re-renders
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,react__WEBPACK_IMPORTED_MODULE_0__.memo)(OneCard));

/***/ }),

/***/ "./src/blocks/magnifying-glass-cards/style.scss":
/*!******************************************************!*\
  !*** ./src/blocks/magnifying-glass-cards/style.scss ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
(() => {
/*!***************************************************!*\
  !*** ./src/blocks/magnifying-glass-cards/view.js ***!
  \***************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_dom_client__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-dom/client */ "./node_modules/react-dom/client.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/magnifying-glass-cards/style.scss");
/* harmony import */ var _Components_Common_Style__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Components/Common/Style */ "./src/blocks/magnifying-glass-cards/Components/Common/Style.js");
/* harmony import */ var _Components_Common_mCard_OneCard__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Components/Common/mCard/OneCard */ "./src/blocks/magnifying-glass-cards/Components/Common/mCard/OneCard.js");
...
document.addEventListener("DOMContentLoaded", () => {
  const blockNameEls = document.querySelectorAll(".wp-block-icb-magnifying-glass-card-pro");
  blockNameEls.forEach(blockNameEl => {
    ...
    (0,react_dom_client__WEBPACK_IMPORTED_MODULE_1__.createRoot)(blockNameEl).render((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_Common_Style__WEBPACK_IMPORTED_MODULE_3__["default"], {
      ...
      id: blockNameEl.id
    }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_Common_mCard_OneCard__WEBPACK_IMPORTED_MODULE_4__["default"], {
      attributes: attributes
    })));
