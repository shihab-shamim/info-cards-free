...
/***/ "./src/blocks/3d-fold-out-reveal/Components/Common/Style.js":
/*!******************************************************************!*\
  !*** ./src/blocks/3d-fold-out-reveal/Components/Common/Style.js ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("style", {
    dangerouslySetInnerHTML: {
      __html: `
         ...
         ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)("", styles?.card?.subTitle?.typo)?.googleFontLink}
         ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)("", styles?.card?.description?.typo)?.googleFontLink}
         ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)("", styles?.card?.btn?.typo)?.googleFontLink}

         
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(titleTextSl, styles?.card?.title?.typo)?.styles}
      ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(subtitleTextSl, styles?.card?.subTitle?.typo)?.styles}
      ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(descriptionSl, styles?.card?.description?.typo)?.styles}
      ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(btnSl, styles?.card?.btn?.typo)?.styles}
    ...
    ${btnSl}{
      ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBackgroundCSS)(styles?.card?.btn?.bg)}
      border-radius:${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(styles?.card?.btn?.border)};
      padding:${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(styles?.card?.btn?.padding)};
...
/***/ "./src/blocks/3d-fold-out-reveal/Components/Common/fcards/OneCards.js":
/*!****************************************************************************!*\
  !*** ./src/blocks/3d-fold-out-reveal/Components/Common/fcards/OneCards.js ***!
  \****************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const OneCards = ({
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    const handleClick = function (e) {
      ...
      if (cardsContainer.classList.contains("dfor-showing")) {
        ...
        const showingCard = cardsContainer.querySelector(".dfor-card.dfor-show");
        if (showingCard) {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      ...
      className: "dfor-card__image-holder"
    }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("img", {
      className: "dfor-card__image",
      src: image,
      alt: title
    })), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "dfor-card-title"
    }, options?.showIcons && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
      href: "#",
      className: "dfor-toggle-info dfor-btn"
    }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
      className: "dfor-left"
    }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
      className: "dfor-right"
    })), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h2", null, options?.showTitle && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
      className: "dfor-title"
    }, title), options?.showSubtitle && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("small", {
      className: "dfor-subtitle"
    }, subtitle))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "dfor-card-flap dfor-flap1"
    }, options?.showDescription && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "dfor-card-description"
    }, description), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "dfor-card-flap dfor-flap2"
    }, options?.showButton && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "dfor-card-actions",
      style: {
        zIndex: 9999
      }
      ...
      rel: options?.linkOpenInNewTab ? "noopener noreferrer" : ""
    }, btn.text)))));
  }));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (OneCards);

/***/ }),

/***/ "./src/blocks/3d-fold-out-reveal/style.scss":
/*!**************************************************!*\
  !*** ./src/blocks/3d-fold-out-reveal/style.scss ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
(() => {
/*!***********************************************!*\
  !*** ./src/blocks/3d-fold-out-reveal/view.js ***!
  \***********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_dom_client__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-dom/client */ "./node_modules/react-dom/client.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/3d-fold-out-reveal/style.scss");
/* harmony import */ var _Components_Common_Style__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Components/Common/Style */ "./src/blocks/3d-fold-out-reveal/Components/Common/Style.js");
/* harmony import */ var _Components_Common_fcards_OneCards__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Components/Common/fcards/OneCards */ "./src/blocks/3d-fold-out-reveal/Components/Common/fcards/OneCards.js");
...
document.addEventListener("DOMContentLoaded", () => {
  const blockNameEls = document.querySelectorAll(".wp-block-icb-fold-out-reveal-pro");
  blockNameEls.forEach(blockNameEl => {
    ...
    (0,react_dom_client__WEBPACK_IMPORTED_MODULE_1__.createRoot)(blockNameEl).render((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_Common_Style__WEBPACK_IMPORTED_MODULE_3__["default"], {
      ...
      id: blockNameEl.id
    }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_Common_fcards_OneCards__WEBPACK_IMPORTED_MODULE_4__["default"], {
      attributes: attributes
    })));
