...
/***/ "./src/blocks/player-cards/Components/Common/Style.js":
/*!************************************************************!*\
  !*** ./src/blocks/player-cards/Components/Common/Style.js ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("style", {
    dangerouslySetInnerHTML: {
      __html: `
        ...
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)("", styles?.card?.des?.typo)?.googleFontLink}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)("", styles?.card?.prompt?.typo)?.googleFontLink}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)("", styles?.card?.role?.typo)?.googleFontLink}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)("", styles?.card?.city?.typo)?.googleFontLink}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)("", styles?.card?.joined?.typo)?.googleFontLink}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)("", styles?.card?.groupName?.typo)?.googleFontLink}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)("", styles?.card?.level?.typo)?.googleFontLink}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)("", styles?.card?.points?.typo)?.googleFontLink}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)("", styles?.card?.stat?.title?.typo)?.googleFontLink}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)("", styles?.card?.stat?.value?.typo)?.googleFontLink}

        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(nameSl, styles?.card?.title?.typo)?.styles}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(descSl, styles?.card?.des?.typo)?.styles}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(promptSl, styles?.card?.prompt?.typo)?.styles}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(roleSl, styles?.card?.role?.typo)?.styles}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(citySl, styles?.card?.city?.typo)?.styles}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(joinedSl, styles?.card?.joined?.typo)?.styles}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(groupNameSl, styles?.card?.groupName?.typo)?.styles}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(levelSl, styles?.card?.level?.typo)?.styles}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(pointsSl, styles?.card?.points?.typo)?.styles}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(statTitleSl, styles?.card?.stat?.title?.typo)?.styles}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(statValueSl, styles?.card?.stat?.value?.typo)?.styles}
        ...
        ${cardSl} {
          ...
          border-width: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(styles?.card?.border?.width) || "0px"};
        }
        ...
        ${sidebarSl} {
           ${styles?.card?.sidebar?.width ? `width: ${styles.card.sidebar.width};` : ""}
           ${styles?.card?.sidebar?.bg_red?.color || styles?.card?.sidebar?.bg_red?.gradient ? `${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBackgroundCSS)(styles.card.sidebar.bg_red)} !important;` : ""}
        }
        ...
        ${sidebarSl} .pcb-sidebar-info {
           ${styles?.card?.sidebar?.width ? `width: calc(100cqi - ${styles.card.sidebar.width});
                  left: ${styles.card.sidebar.width};` : ""}
        }

        ${cardSl} .pcb-main-content {
           ${styles?.card?.sidebar?.width ? `width: calc(100% - ${styles.card.sidebar.width});` : ""}
        }

        ${cardSl}.pcb-theme-green .pcb-sidebar {
           ${styles?.card?.sidebar?.bg_green?.color || styles?.card?.sidebar?.bg_green?.gradient ? `${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBackgroundCSS)(styles.card.sidebar.bg_green)} !important;` : ""}
        }

        ${sidebarSl} .pcb-user-avatar::after {
           ${styles?.card?.sidebar?.divider?.width ? `border-left-width: ${styles.card.sidebar.divider.width} !important;` : ""}
           ${styles?.card?.sidebar?.divider?.color_red ? `border-left-color: ${styles.card.sidebar.divider.color_red} !important;` : ""}
        }
        
        ${cardSl}.pcb-theme-green .pcb-sidebar .pcb-user-avatar::after {
           ${styles?.card?.sidebar?.divider?.color_green ? `border-left-color: ${styles.card.sidebar.divider.color_green} !important;` : ""}
        }

        ${nameSl} {
          ${styles?.card?.title?.color ? `color: ${styles.card.title.color};` : ""}
        }

        ${cardSl}:hover h1 {
          ${styles?.card?.title?.hoverColor ? `color: ${styles.card.title.hoverColor} !important;` : ""}
        }

        ${descSl} {
          ${styles?.card?.des?.color ? `color: ${styles.card.des.color};` : ""}
          margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(styles?.card?.des?.margin)};
        }
        
        ${promptSl} {
          ${styles?.card?.prompt?.color ? `color: ${styles.card.prompt.color};` : ""}
        }
        
        ${roleSl} {
          ${styles?.card?.role?.color_red ? `color: ${styles.card.role.color_red};` : ""}
        }

        ${cardSl}.pcb-theme-green .pcb-role-text {
          ${styles?.card?.role?.color_green ? `color: ${styles.card.role.color_green} !important;` : ""}
        }
        
        ${citySl} {
          ${styles?.card?.city?.color_red ? `color: ${styles.card.city.color_red};` : ""}
        }

        ${cardSl}.pcb-theme-green .pcb-city-text {
          ${styles?.card?.city?.color_green ? `color: ${styles.card.city.color_green} !important;` : ""}
        }
        
        ${joinedSl} {
          ${styles?.card?.joined?.color_red ? `color: ${styles.card.joined.color_red};` : ""}
        }

        ${cardSl}.pcb-theme-green .pcb-joined-text {
          ${styles?.card?.joined?.color_green ? `color: ${styles.card.joined.color_green} !important;` : ""}
        }
        
        ${groupNameSl} {
          ${styles?.card?.groupName?.color_red ? `color: ${styles.card.groupName.color_red};` : ""}
        }

        ${cardSl}.pcb-theme-green .pcb-groupName-text {
          ${styles?.card?.groupName?.color_green ? `color: ${styles.card.groupName.color_green} !important;` : ""}
        }

        ${levelSl} {
          ${styles?.card?.level?.color ? `color: ${styles.card.level.color};` : ""}
          ${styles?.card?.level?.bg ? `background-color: ${styles.card.level.bg};` : ""}
          padding: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(styles?.card?.level?.padding)};
        }
        
        ${pointsSl} {
          ${styles?.card?.points?.color ? `color: ${styles.card.points.color};` : ""}
          ${styles?.card?.points?.bg ? `background-color: ${styles.card.points.bg};` : ""}
          padding: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(styles?.card?.points?.padding)};
        }
        
        ${statTitleSl} {
          ${styles?.card?.stat?.title?.color_red ? `color: ${styles.card.stat.title.color_red};` : ""}
        }
        
        ${cardSl}.pcb-theme-green .pcb-stat-title {
          ${styles?.card?.stat?.title?.color_green ? `color: ${styles.card.stat.title.color_green} !important;` : ""}
        }

        ${statValueSl} {
          ${styles?.card?.stat?.value?.color_red ? `color: ${styles.card.stat.value.color_red};` : ""}
        }

        ${cardSl}.pcb-theme-green .pcb-stat-value {
          ${styles?.card?.stat?.value?.color_green ? `color: ${styles.card.stat.value.color_green} !important;` : ""}
        }

        ${statIconSl} {
          ${styles?.card?.stat?.icon?.color_red ? `color: ${styles.card.stat.icon.color_red} !important;` : ""}
          width: ${typeof styles?.card?.stat?.icon?.size === "number" ? styles.card.stat.icon.size + "px" : styles?.card?.stat?.icon?.size || "40px"} ;
          height: ${typeof styles?.card?.stat?.icon?.size === "number" ? styles.card.stat.icon.size + "px" : styles?.card?.stat?.icon?.size || "40px"} ;
        }

        ${cardSl}.pcb-theme-green .pcb-stat-icon svg {
          ${styles?.card?.stat?.icon?.color_green ? `color: ${styles.card.stat.icon.color_green} !important;` : ""}
        }

        ${statIconSl} *:not([fill="none"]) {
          ${styles?.card?.stat?.icon?.color_red || styles?.card?.stat?.icon?.color_green ? `fill: currentColor !important;` : ""}
        }

        ${statIconSl} [stroke]:not([stroke="none"]) {
          ${styles?.card?.stat?.icon?.color_red || styles?.card?.stat?.icon?.color_green ? `stroke: currentColor !important;` : ""}
        }

        ${imageSl} {
          width: ${styles?.card?.image?.width || "110px"};
          height: ${styles?.card?.image?.height || "110px"};
          border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(styles?.card?.image?.radius)};
          position: absolute;
          left: 50%;
...
/***/ "./src/blocks/player-cards/Components/Common/player-cards/OneCard.js":
/*!***************************************************************************!*\
  !*** ./src/blocks/player-cards/Components/Common/player-cards/OneCard.js ***!
  \***************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _utils_functions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../utils/functions */ "./src/blocks/player-cards/utils/functions.js");
...
const PlayerCard = ({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: `pcb-profile-card ${themeClass || ""}`
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "pcb-sidebar"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "pcb-user-avatar"
  }, options?.isLevelShow && !RichTextComponent && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "pcb-user-level"
  }, level), options?.isLevelShow && RichTextComponent && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(RichTextComponent, {
    val: level,
    onChange: val => setAttributes({
      cards: (0,_utils_functions__WEBPACK_IMPORTED_MODULE_1__.updateData)(attributes.cards, val, index, "level")
    }),
    tagName: "div",
    className: "pcb-user-level",
    placeholder: "Level"
  }), options?.isPointsShow && !RichTextComponent && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "pcb-user-points"
  }, points), options?.isPointsShow && RichTextComponent && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(RichTextComponent, {
    val: points,
    onChange: val => setAttributes({
      cards: (0,_utils_functions__WEBPACK_IMPORTED_MODULE_1__.updateData)(attributes.cards, val, index, "points")
    }),
    tagName: "div",
    className: "pcb-user-points",
    placeholder: "Points"
    ...
    id: "title"
  }, "Teacher"), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("desc", {
    id: "desc"
  }, "Cartoon of a Caucasian woman smiling, and wearing black glasses and a purple shirt with white collar drawn by Alvaro Montoro."), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("style", null, `
    ...
    className: "pcb-sidebar-info"
  }, options?.isNameShow && !RichTextComponent && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h1", null, name), options?.isNameShow && RichTextComponent && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(RichTextComponent, {
    placeholder: "Enter your name",
    tagName: "h1",
    val: name,
    onChange: val => setAttributes({
      cards: (0,_utils_functions__WEBPACK_IMPORTED_MODULE_1__.updateData)(attributes.cards, val, index, "name")
    })
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "pcb-user-metadata"
  }, options?.isGroupNameShow && !RichTextComponent && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "pcb-groupName-text"
  }, groupName), options?.isGroupNameShow && RichTextComponent && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(RichTextComponent, {
    placeholder: "Group Name",
    tagName: "span",
    className: "pcb-groupName-text",
    val: groupName,
    onChange: val => setAttributes({
      cards: (0,_utils_functions__WEBPACK_IMPORTED_MODULE_1__.updateData)(attributes.cards, val, index, "groupName")
    })
  }), options?.isJoinedShow && !RichTextComponent && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "pcb-joined-text"
  }, joined), options?.isJoinedShow && RichTextComponent && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(RichTextComponent, {
    placeholder: "Joined",
    tagName: "span",
    className: "pcb-joined-text",
    val: joined,
    onChange: val => setAttributes({
      cards: (0,_utils_functions__WEBPACK_IMPORTED_MODULE_1__.updateData)(attributes.cards, val, index, "joined")
    })
  })), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "pcb-user-metadata"
  }, options?.isRoleShow && !RichTextComponent && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "pcb-role-text"
  }, role), options?.isRoleShow && RichTextComponent && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(RichTextComponent, {
    placeholder: "Role",
    tagName: "span",
    className: "pcb-role-text",
    val: role,
    onChange: val => setAttributes({
      cards: (0,_utils_functions__WEBPACK_IMPORTED_MODULE_1__.updateData)(attributes.cards, val, index, "role")
    })
  }), options?.isCityShow && !RichTextComponent && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "pcb-city-text"
  }, city), options?.isCityShow && RichTextComponent && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(RichTextComponent, {
    placeholder: "City",
    tagName: "span",
    className: "pcb-city-text",
    val: city,
    onChange: val => setAttributes({
      cards: (0,_utils_functions__WEBPACK_IMPORTED_MODULE_1__.updateData)(attributes.cards, val, index, "city")
    })
  })), options?.isStatsShow && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "pcb-stats-container"
  }, stats?.map((stat, sIndex) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    key: sIndex
  }, !RichTextComponent && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "pcb-stat-title"
  }, stat.title), RichTextComponent && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(RichTextComponent, {
    placeholder: "Title",
    tagName: "div",
    className: "pcb-stat-title",
    val: stat.title,
    onChange: val => setAttributes({
      cards: (0,_utils_functions__WEBPACK_IMPORTED_MODULE_1__.updateData)(attributes.cards, val, index, "stats", sIndex, "title")
    })
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: `pcb-stat-value ${stat.isInfinity ? "pcb-stat-infinity" : ""}`
  }, stat.value), RichTextComponent && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(RichTextComponent, {
    placeholder: "Value",
    tagName: "div",
    className: `pcb-stat-value ${stat.isInfinity ? "pcb-stat-infinity" : ""}`,
    val: stat.value,
    onChange: val => setAttributes({
      cards: (0,_utils_functions__WEBPACK_IMPORTED_MODULE_1__.updateData)(attributes.cards, val, index, "stats", sIndex, "value")
    })
  })))))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "pcb-main-content"
  }, options?.isNameShow && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h1", null, name), options?.isDescriptionShow && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, description), options?.isPromptShow && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "pcb-hover-prompt"
...
const OneCard = ({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "pcb-main-wrapper"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "pcb-card-grid"
  }, cards?.map((card, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(PlayerCard, {
    key: index,
    ...card,
    options: options,
...
/***/ "./src/blocks/player-cards/style.scss":
/*!********************************************!*\
  !*** ./src/blocks/player-cards/style.scss ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/blocks/player-cards/utils/functions.js":
/*!****************************************************!*\
  !*** ./src/blocks/player-cards/utils/functions.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
(() => {
/*!*****************************************!*\
  !*** ./src/blocks/player-cards/view.js ***!
  \*****************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_dom_client__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-dom/client */ "./node_modules/react-dom/client.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/player-cards/style.scss");
/* harmony import */ var _Components_Common_Style__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Components/Common/Style */ "./src/blocks/player-cards/Components/Common/Style.js");
/* harmony import */ var _Components_Common_player_cards_OneCard__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Components/Common/player-cards/OneCard */ "./src/blocks/player-cards/Components/Common/player-cards/OneCard.js");
...
document.addEventListener("DOMContentLoaded", () => {
  const blockNameEls = document.querySelectorAll(".wp-block-pcb-player-cards-pro");
  blockNameEls.forEach(blockNameEl => {
    ...
    (0,react_dom_client__WEBPACK_IMPORTED_MODULE_1__.createRoot)(blockNameEl).render((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_Common_Style__WEBPACK_IMPORTED_MODULE_3__["default"], {
      attributes: attributes,
      id: blockNameEl.id
    }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_Common_player_cards_OneCard__WEBPACK_IMPORTED_MODULE_4__["default"], {
      attributes: attributes
    })));
