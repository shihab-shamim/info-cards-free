...
/***/ "./src/blocks/expanding-flex-cards/Components/Common/Style.js":
/*!********************************************************************!*\
  !*** ./src/blocks/expanding-flex-cards/Components/Common/Style.js ***!
  \********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const Style = ({
  ...
  const icondynamiccolor = cards.map((card, index) => {
    return `
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("style", {
    dangerouslySetInnerHTML: {
      __html: `
			...
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(`${efcCardTitleSl}`, styles?.card?.title?.typo)?.styles}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(`${efcCardSubtitleSl}`, styles?.card?.subtitle?.typo)?.styles}
		...
		${efcCardSubtitleSl}{
			...
			margin:${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(styles?.card?.subtitle?.margin)};
		}
...
/***/ "./src/blocks/expanding-flex-cards/Components/Common/eCards/OneCard.js":
/*!*****************************************************************************!*\
  !*** ./src/blocks/expanding-flex-cards/Components/Common/eCards/OneCard.js ***!
  \*****************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _utils_functions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../utils/functions */ "./src/blocks/expanding-flex-cards/utils/functions.js");
...
const OneCard = ({
  ...
  const [activeCard, setActiveCard] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(0);
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "efc-container"
    ...
    className: "efc-card-shadow"
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "efc-card-label"
  }, options?.isIconshow && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: `efc-card-icon  efc-card-icon-${index}`,
    dangerouslySetInnerHTML: {
      __html: card.icon
    }
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "efc-card-info"
  }, options?.isTitleshow && !RichTextComponent && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    href: card.link,
    target: options?.isOpenNewTab ? "_blank" : "_self",
    className: "efc-card-title",
    rel: "noreferrer"
  }, card.title), options?.isTitleshow && RichTextComponent && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(RichTextComponent, {
    val: card.title,
    onChange: val => {
      setAttributes({
        cards: (0,_utils_functions__WEBPACK_IMPORTED_MODULE_1__.updateData)(cards, val, index, "title")
      });
    },
    tagName: "div",
    className: "efc-card-title",
    placeholder: "Title"
  }), options?.isSubtitleShow && !RichTextComponent && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "efc-card-subtitle"
  }, card.subtitle), options?.isSubtitleShow && RichTextComponent && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(RichTextComponent, {
    val: card.subtitle,
    onChange: val => {
      setAttributes({
        cards: (0,_utils_functions__WEBPACK_IMPORTED_MODULE_1__.updateData)(cards, val, index, "subtitle")
      });
    },
    tagName: "div",
    className: "efc-card-subtitle",
...
/***/ "./src/blocks/expanding-flex-cards/style.scss":
/*!****************************************************!*\
  !*** ./src/blocks/expanding-flex-cards/style.scss ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/blocks/expanding-flex-cards/utils/functions.js":
/*!************************************************************!*\
  !*** ./src/blocks/expanding-flex-cards/utils/functions.js ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
(() => {
/*!*************************************************!*\
  !*** ./src/blocks/expanding-flex-cards/view.js ***!
  \*************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_dom_client__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-dom/client */ "./node_modules/react-dom/client.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/expanding-flex-cards/style.scss");
/* harmony import */ var _Components_Common_Style__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Components/Common/Style */ "./src/blocks/expanding-flex-cards/Components/Common/Style.js");
/* harmony import */ var _Components_Common_eCards_OneCard__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Components/Common/eCards/OneCard */ "./src/blocks/expanding-flex-cards/Components/Common/eCards/OneCard.js");
...
document.addEventListener("DOMContentLoaded", () => {
  const blockNameEls = document.querySelectorAll(".wp-block-icb-expanding-flex-cards-pro");
  blockNameEls.forEach(blockNameEl => {
    ...
    (0,react_dom_client__WEBPACK_IMPORTED_MODULE_1__.createRoot)(blockNameEl).render((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_Common_Style__WEBPACK_IMPORTED_MODULE_3__["default"], {
      ...
      id: blockNameEl.id
    }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_Common_eCards_OneCard__WEBPACK_IMPORTED_MODULE_4__["default"], {
      attributes
    })));
