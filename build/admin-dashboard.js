...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ([{
  name: "info-cards",
  title: "Info Cards",
  icon: _utils_icons__WEBPACK_IMPORTED_MODULE_0__.infoCardsIcon,
  isPremium: false,
  required: true
}, {
  name: "player-cards",
  title: "Player Cards",
  icon: _utils_icons__WEBPACK_IMPORTED_MODULE_0__.playerCardsIcon,
  isPremium: true
}, {
  name: "news-cards",
  title: "News Cards",
  icon: _utils_icons__WEBPACK_IMPORTED_MODULE_0__.newsCardsIcon,
  isPremium: true
}, {
  name: "magnifying-glass-cards",
  title: "Magnifying Glass Cards",
  icon: _utils_icons__WEBPACK_IMPORTED_MODULE_0__.magnifyingGlassCardsIcon,
  isPremium: true
}, {
  name: "expanding-flex-cards",
  title: "Expanding Flex Cards",
  icon: _utils_icons__WEBPACK_IMPORTED_MODULE_0__.expandingFlexCardsIcon,
  isPremium: true
}, {
  name: "expandable-animated-card-slider",
  title: "Expandable Animated Card Slider",
  icon: _utils_icons__WEBPACK_IMPORTED_MODULE_0__.expandableAnimatedCardSliderIcon,
  isPremium: true
}, {
  name: "animated-gradient-cards",
  title: "Animated Gradient Cards",
  icon: _utils_icons__WEBPACK_IMPORTED_MODULE_0__.animatedGradientCardsIcon,
  isPremium: true
}, {
  name: "3d-fold-out-reveal",
  title: "3D Fold Out Reveal",
  icon: _utils_icons__WEBPACK_IMPORTED_MODULE_0__.foldOutRevealIcon,
  isPremium: true
}, {
  name: "nice-box",
  title: "Nice Box",
  icon: _utils_icons__WEBPACK_IMPORTED_MODULE_0__.niceBoxIcon,
  isPremium: true
}]);
...
const welcomeInfo = (adminUrl = "") => ({
  ...
  gettingStarted: {
    tabs: [{
      ...
      steps: [{
        ...
        link: {
          url: `${adminUrl}post-new.php?post_type=icb`,
          label: "Add New"
        }
      }, {
        num: 2,
        ...
        link: {
          url: `${adminUrl}edit.php?post_type=icb`,
  ...
  changelogs: [{
    version: "3.0.1",
    type: "fix",
    list: ["<strong>Update:</strong> Added a modern and intuitive dashboard layout.", "<strong>Fix:</strong> CDN loading issue on page load."]
  }, {
    version: "3.0.0",
    type: "new",
  ...
  proFeatures: ["Universal Shortcodes: Compatible with all page builders.", "Fully Customizable", "Set Custom Color", "Built-in Templates", "Set Columns, Column Gap and Row Gap", "Use an Image in the Card", "Support Links & Buttons", "Typography Control", "Responsive Layout", "Easy to Use", "12+ Pre-built Info Card Layouts", "Customizable Title & Description", "Feature List Support Inside Cards", "Customizable Icon", "Icon Size & Style Control", "Background & Gradient Customization", "Padding & Spacing Options", "Border Style & Radius Control", "Added 7+ new built-in blocks."]
});
const demoInfo = {
  demos: [{
    icon: _utils_icons__WEBPACK_IMPORTED_MODULE_0__.infoCardsIcon,
